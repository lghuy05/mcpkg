...
export async function suggestInstallRetry(server, config, verification) {
...
function getDeterministicFailureDecision(verification) {
...
function buildRetryPrompt(server, config, verification) {
    return [
...
function toInstallQuestion(question) {
